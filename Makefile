...
releases:
	make clean; make openssl_key; make all; tar cvfz ./http_proxy_linux.tar.gz bin res; mv ./http_proxy_linux.tar.gz ../releases/http_proxy
	make clean; make openssl_key; make linux_armv5; tar cvfz ./http_proxy_linux_armv5.tar.gz bin res; mv ./http_proxy_linux_armv5.tar.gz ../releases/http_proxy
	make clean; make openssl_key; make linux_armv7; tar cvfz ./http_proxy_linux_armv7.tar.gz bin res; mv ./http_proxy_linux_armv7.tar.gz ../releases/http_proxy
	make clean; make openssl_key; make linux_armv8; tar cvfz ./http_proxy_linux_armv8.tar.gz bin res; mv ./http_proxy_linux_armv8.tar.gz ../releases/http_proxy
	make clean; make openssl_key; make linux_mips; tar cvfz ./http_proxy_linux_mips.tar.gz bin res; mv ./http_proxy_linux_mips.tar.gz ../releases/http_proxy
	make clean; make openssl_key; make mac; tar cvfz ./http_proxy_macos.tar.gz bin res; mv ./http_proxy_macos.tar.gz ../releases/http_proxy
	make clean; make openssl_key; make windows; tar cvfz ./http_proxy_windows.tar.gz bin res; mv ./http_proxy_windows.tar.gz ../releases/http_proxy
